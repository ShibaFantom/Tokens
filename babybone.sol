...
contract BABYCAKE is ERC20, Ownable {
    ...
    address public immutable BONE = address(0x8a0d557BB132Dbe2C9Aa3CFb6Ef81eeE4107057a); //BONE
    ...
    constructor() public ERC20("BABY CAKE", "BABYCAKE") {
    	...
    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xB6f7b3d8CD9dBf30805C0dd79809dace5603Ce6A);
